...
class Order extends Application {
    ...
    // start a new order
    function neworder() {
        // set the $order_num to last number used plus 1
        $order_num = $this->orders->highest() + 1;

        // creates a new object, with all the fields from the Orders table, initialized to blank
        ...
        $neworder->status = 'a';
        $neworder->total = 0;
        // save the new order object (add it to the orders model)
    ...
    function display_menu($order_num = null) {
        ...
        // retrieve the order record from the orders table
